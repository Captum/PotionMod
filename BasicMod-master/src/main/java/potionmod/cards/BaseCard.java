package potionmod.cards;

import basemod.abstracts.CustomCard;
import potionmod.potionmod;
import potionmod.util.CardInfo;

import static potionmod.potionmod.makeID;
import static potionmod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    potionmod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
